...
class ShowValuePage extends StatefulWidget {
  const ShowValuePage({super.key, required this.title});
  ...
  @override
  State<ShowValuePage> createState() => _ShowValuePageState();
}
...
class _ShowValuePageState extends State<ShowValuePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => ShowValueBloc(ShowValueState.initial()),
      child: Scaffold(
        appBar: AppBar(
